...
abstract contract IProtocolController {
    ...
    // public getters
    function getGlobalParams() public virtual view returns(GlobalParams memory);
    ...
    function validateGlobalParams(GlobalParams memory newParams) public view virtual;
